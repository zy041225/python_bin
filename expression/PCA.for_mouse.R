...
for(i in 1:6){
	for(j in (i+1):7){
		plot(res$weights[,i],res$weights[,j],col=c("blue","blue","blue","blue","cyan","cyan","cyan","red","red","red","yellow","yellow","yellow","orange","orange","orange","green","green","green","purple","purple","purple","purple","black","black","black"), pch=19, xlab = i, ylab = j)
