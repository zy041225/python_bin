...
for(i in 1:6){
	for(j in (i+1):7){
		plot(res$weights[,i],res$weights[,j],col=c("blue","blue","blue","cyan","cyan","red","red","yellow","yellow","orange","orange","green","green","green","black","black","black"), pch=19, xlab = i, ylab = j)
