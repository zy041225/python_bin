...
def draw_gene(gene_list, d, scale, leftmost, topmost, ort='+', bg='NA', ed='NA', arrow=1, name=1):
	import svgwrite
	import sys
	...
	for info in sorted(gene_list, key = lambda x: x[1]):
		...
		if name==1: d.add(d.text(id, insert = (xloc-5, yloc), font_size = 8, fill = 'black', font_family = 'Arial'))
		if arrow==1:
...
def draw_gene_v1(gene_info, id, d, scale, leftmost, topmost, ort='+', bg='NA', ed='NA', arrow=1, name=1):
	import svgwrite
	import sys
	...
	if arrow == 1:
		...
		if name == 1: d.add(d.text(id, insert = (x-5, yloc-5-8), font_size = 8, fill = 'black', font_family = 'Arial'))
	return d

def draw_gene_v2(gene_info, id, d, scale, leftmost, topmost, ort='+', bg='NA', ed='NA', arrow=1, name=1, axis='x'):
	import svgwrite
	import sys
...
def draw_gene_model(cds_list, id, d, scale, leftmost, topmost, ort='+', bg='NA', ed='NA', arrow=1, name=1):
	import svgwrite
	import sys
	...
	for info in cds_list:
		...
		if name == 1 and count == 1: d.add(d.text(id, (x-5, yloc-8), font_size = 8, fill = 'black', font_family = 'Arial'))
